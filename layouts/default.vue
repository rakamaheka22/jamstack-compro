  ...
  <div class="bg-gray-200 h-full">
    <nav class="w-full flex items-center justify-between flex-wrap bg-gray-800 p-6">
      ...
      <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
        ...
        <div>
          <nuxt-link to="/post" class="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 lg:mt-0">Add Article</nuxt-link>
        </div>
      </div>
    </nav>
    <Nuxt />
