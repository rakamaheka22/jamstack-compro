          ...
          <div class="container px-4 sm:px-8 lg:px-16 xl:px-20 mx-auto">
              ...
              <div class="hero-wrapper grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                  ...
                  <div class="hero-text col-span-6">
                      <h1 class=" font-bold text-4xl md:text-5xl max-w-xl text-gray-900 leading-tight">Welcome to<br>JAM Stack Compro!</h1>
                      <hr class=" w-12 h-1 bg-teal-500 rounded-full mt-8">
                      <p class="text-gray-800 text-base leading-relaxed mt-8 font-semibold">Your ultimate web stack. All the information you need about Javascript</p>
                      <div class="get-app flex space-x-5 mt-10 justify-center md:justify-start">
                          <button class="apple bg-white shadow-md px-3 py-2 rounded-lg flex items-center space-x-4">
                              <div class="text">
                                  <p class="font-semibold text-gray-900">Go to Blog</p>
                              </div>
                          </button>
                      </div>
                  </div>
